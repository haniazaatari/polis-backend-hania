#!/usr/bin/env python3
"""
Script to extract and analyze math_main data structure from PostgreSQL.

This script extracts the math object for a specific conversation,
examines its structure, and logs detailed information about group assignments.
"""
...
def extract_math_data(zid):
    ...
    try:
        ...
        results = postgres_client.query(sql, {"zid": zid})
        ...
        analyze_math_structure(math_data, zid)
...
def analyze_math_structure(math_data, zid):
    """
