...
const mockHandleCreateComment = jest.fn((req, res) => {
  const { conversation_id, txt } = req.body;
...
const mockHandleGetComments = jest.fn((req, res) => {
  ...
  res.json([
    {
      tid: 123,
      conversation_id: Number.parseInt(conversation_id, 10),
      txt: 'Test comment 1',
...
const mockHandleGetCommentTranslations = jest.fn((req, res) => {
